        ...
        >
          ...
          {loading ? (
            <div className={styles.loadingState}>
              ...
              <p className={styles.loadingSubtext}>Gemini Vision is analysing your image</p>
            </div>
          ) : (
            <div className={styles.idleState}>
              ...
              <p className={styles.mainText}>Drop receipt here</p>
              <p className={styles.subText}>or click to browse · JPEG, PNG, WebP</p>
        ...
        <div className={styles.previewWrapper}>
          ...
          <div className={styles.previewActions}>
            <button className="btn btn-primary" onClick={handleProcess} id="process-receipt-btn">
              ...
              Extract {pendingFiles.length} {pendingFiles.length === 1 ? 'Receipt' : 'Receipts'}
            </button>
