      ...
      >
        ...
        <div className={styles.body}>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.infoBox} style={{ marginTop: 'var(--space-md)', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
                </svg>
                <span>
                  Setup Database: Maak tabel <code>bonnetje_data</code> met kolommen: <code>id</code> (text pk) en <code>data</code> (jsonb).
                </span>
              </div>
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <span>
                  Setup Opslag: Maak een <strong>Storage Bucket</strong> genaamd <code>receipts</code> en maak deze <strong>Public</strong>. Dit is nodig om de bonnetjesfoto's permanent op te slaan.
                </span>
              </div>
            </div>
          </div>
